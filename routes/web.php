...
Route::put('/features/{feature}/action-estimated-hours', [\App\Http\Controllers\FeatureController::class, 'actionEstimatedHours'])
    ->name('features.action-estimated-hours');
